      ...
      >
        ...
        >
          ...
          <button 
            ...
            className="px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-full font-medium transition-all flex items-center gap-2 group shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:-translate-y-0.5"
          >
            Voir mon CV
            {/* <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /> */}
          </button>
