    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="relative flex items-center bg-white/5 border border-white/10 rounded-full shadow-lg">
          ...
          {/* Option Développeur */}
          <button
            onClick={() => setActiveProfile("developpeur")}
            className={`relative z-10 flex items-center gap-1 px-2 py-1.5 rounded-full text-xs sm:text-sm font-bold transition-colors duration-300 ${activeProfile === "developpeur" ? "text-white" : "text-gray-400 hover:text-white"
              }`}
          >
          ...
          {/* Option Ingénierie */}
          <button
            onClick={() => setActiveProfile("embarque")}
            className={`relative z-10 flex items-center gap-1 px-2 py-1.5 rounded-full text-xs sm:text-sm font-bold transition-colors duration-300 ${activeProfile === "embarque" ? "text-white" : "text-gray-400 hover:text-white"
              }`}
          >
